...
Author: Uday Agrawal (uagrawal) last update: 1/22/16
"""
...
class IntellivueData(object):
    ...
    write messages to communicate with the Intellivue Monitor.

    Division of Functions:

    *Read*
    readAttributeList()
    readVariableLengthList()
    readVariableLabel()
    readVariableData()
    readString()
    readFLOAT()
    ...
    *Import Data*
    ...
    There are four main data structures (all dictionaries):
        ...
        DataTypes -
            ...
            Notes:
                ...
                length, ASNLength, LILength, all have the name of the
    ...
    def __init__(self):
        ...
        self.DataTypes["EventReportArgument"] = [
            "ManagedObjectID",
            "RelativeTime",
            "OIDType",
            "length",
        ...
        self.DataTypes["ProtoSupportEntry"] = [
            "ApplProtoID",
            "TransProtoID",
            "port_number",
            "ProtoOptions",
        ...
        self.DataTypes["AssocReqSessionHeader"] = [
            "AssocReqSessionHead",
            "LILength_AssocReqPresentationTrailer",
        ]
        self.DataTypes["AssocReqPresentationHeader"] = [
            "AssocReqPresentationHead1",
            "LILength_AssocReqPresentationTrailer",
            "AssocReqPresentationHead2",
        ]
        self.DataTypes["AssocReqUserData"] = [
            "ASNLength_MDSEUserInfoStd",
            "MDSEUserInfoStd",
        ]
        self.DataTypes["MDSEUserInfoStd"] = [
            "ProtocolVersion",
            "NomenclatureVersion",
            "FunctionalUnits",
            "SystemType",
        ...
        self.DataTypes["supported_aprofiles"] = [
            "AttributeList",
            ["NOM_POLL_PROFILE_SUPPORT"],
        ]
        self.DataTypes["NullAttribute"] = [32]
        self.DataTypes["PollProfileSupport"] = [
            "PollProfileRevision",
            "min_poll_period",
            "max_mtu_rx",
            "max_mtu_tx",
        ...
        self.DataTypes["PollProfileSupport_optional_packages"] = [
            "AttributeList",
        ...
        self.DataTypes["AssocRespUserData"] = [
            "ASNLength_MDSEUserInfoStd",
            "MDSEUserInfoStd",
        ]
        ...
        self.DataTypes["MdsGenSystemInfo"] = [
            "count",
            "length_MdsGenSystemInfo",
            "MdsGenSystemInfoEntry",
        ]
        self.DataTypes["MdsGenSystemInfoEntry"] = [
            "choice",
            "length_MdsGenSystemInfoEntry",
            "SystemPulseInfo",
        ]
        ...
        self.DataTypes["SystemSpecEntry"] = [
            "OIDType",
            "length_SystemSpecEntry",
            "SystemSpecEntryValue",
        ]
        self.DataTypes["SystemSpecEntryValue"] = [
            "count",
            "length_SystemSpecEntryValue",
            "MdibObjectSupportEntry",
        ]
        self.DataTypes["MdibObjectSupportEntry"] = ["Type", "max_inst"]
        self.DataTypes["max_inst"] = [32]
        self.DataTypes["EventReportResult"] = [
            "ManagedObjectID",
            "RelativeTime",
            "OIDType",
            "length_final",
        ]
        self.DataTypes["ActionArgument"] = [
            "ManagedObjectID",
            "scope",
            "action_type",
            "length_final",
        ...
        self.DataTypes["PollMdibDataReply"] = [
            "poll_number",
            "RelativeTime",
            "AbsoluteTime",
            "Type",
        ...
        self.DataTypes["PollMdibDataReplyExt"] = [
            "poll_number",
            "sequence_no",
            "RelativeTime",
            "AbsoluteTime",
        ...
        self.DataTypes["GetArgument"] = [
            "ManagedObjectID",
            "scope",
            "ArgumentAttributeIdList",
        ]
        self.DataTypes["ArgumentAttributeIdList"] = [
            "AttributeIdList",
            ["NOM_ATTR_POLL_RTSA_PRIO_LIST", "NOM_ATTR_POLL_NU_PRIO_LIST"],
        ]
        ...
        self.DataTypes["ModificationList"] = [
            "count",
            "length_ModificationList",
            "AttributeModEntry",
        ]
        self.DataTypes["AttributeModEntry"] = ["ModifyOperator", "PriorityList"]
        self.DataTypes["PriorityList"] = [
            "OIDType",
            "length_PriorityList",
            "TextIdLabel",
        ]
        ...
        self.DataTypes["SaObsValueCmp"] = [
            "count",
            "length_SaObsValueCmp",
            "SaObsValue",
        ]
        ...
        self.DataTypes["SaVisualGrid16"] = [
            "count",
            "length_SaVisualGrid16",
            "SaGridEntry16",
        ]
        ...
        self.DataTypes["SaFixedValSpec16"] = [
            "count",
            "length_SaFixedValSpec16",
        ...
        self.DataTypes["DeviceAlertCondition"] = [
            "device_alert_state",
            "al_stat_chg_cnt",
            "max_p_alarm",
            "max_t_alarm",
        ...
        self.DataTypes["DevAlarmList"] = [
            "count",
            "length_DevAlarmList",
            "DevAlarmEntry",
        ]
        self.DataTypes["DevAlarmEntry"] = [
            "al_source_code",
            "AlertType",
            "AlertState",
            "ManagedObjectID",
            "alert_info_id",
            "length_DevAlarmEntry",
            "StrAlMonInfo",
        ]
        self.DataTypes["StrAlMonInfo"] = [
            "al_inst_no",
            "TextId",
            "AlertPriority",
            "AlertFlags",
        ...
        self.DataKeys["AttributeType"] = {
            ...
            "NOM_ATTR_PT_NAME": "String",
            "NOM_ATTR_PT_NAME_GIVEN": "String",
            "NOM_ATTR_PT_NAME_FAMILY": "String",
            "NOM_ATTR_PT_NAME_MIDDLE": "String",
            "NOM_ATTR_PT_NAME_BIRTH": "String",
            "NOM_ATTR_PT_NAME_TITLE": "String",
    ...
    def loadOIDTypes(self):
        ...
        -------
        OID_Type: dict
            bidirectional dict organized label:number, number:label
        """

        oid_file = open(
            os.path.join(os.path.dirname(os.path.abspath(__file__)), "OIDTypes.txt"),
            "r",
        )
        labels = []
        numbers = []
    ...
    def loadEventTypes(self):
        """Creates a dictionary from the txt file EventTypes.txt with label: number
        and number: label
        ...
        event_file = open(
            os.path.join(os.path.dirname(os.path.abspath(__file__)), "EventTypes.txt"),
            "r",
        )
        labels = []
        numbers = []
    ...
    def loadSCADATypes(self):
        ...
        scada_file = open(
            os.path.join(os.path.dirname(os.path.abspath(__file__)), "SCADATypes.txt"),
            "r",
        )
        labels = []
        numbers = []
    ...
    def loadUNITTypes(self):
        ...
        -------
        Unit_Type: dict
            bidirectional dict organized unit:number, number:unit

        """

        unit_filename = os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "UNITTypes.txt"
        )
        unit_file = codecs.open(unit_filename, "r", "utf-8")
        labels = []
        numbers = []
        units = []

        for line in unit_file:
            if line.startswith("NOM_DIM"):
                split_line = line.split()
    ...
    def loadPhysioLabels(self):
        ...
        -------
        Label: dict
            dict organized symbol:bytes, label: bytes, bytes: label

        """

        label_file = open(
            os.path.join(
                os.path.dirname(os.path.abspath(__file__)), "PhysioLabels.txt"
            ),
            "r",
        )
        labels = []
        ...
        for line in label_file:
            ...
            if current_line.startswith("Label:"):
                ...
                # Special case where L has descriptor after in label
                    ...
                    descriptions.append(
                        " ".join(split_label_line[2:-1] + [split_label_line[-1]])
                    )
                ...
                # Every other case
                    ...
                    labels.append(split_label_line[0])
                    descriptions.append(
                        " ".join(split_label_line[1:-1] + [split_label_line[-1]])
                    )
    ...
    def loadPhysioKeys(self):
        ...
        -------
        Label_Dict: dict
            dict organized description: labels
        ...
        while current_line:
            ...
            while current_line.startswith("Label:") == 0 and current_line:
                if (
                    current_line.startswith("NOM")
                    and current_line.startswith("NOM_DIM") == 0
                ):
    ...
    def readAttributeList(self, index, current_message_dict, data):
        ...
        current_message_dict["AttributeList"]["count"] = self.get16(
            data[index : index + 2]
        )
        current_message_dict["AttributeList"]["length"] = self.get16(
        ...
        if current_message_dict["AttributeList"]["count"] == 0:
            ...
            for i in range(current_message_dict["AttributeList"]["count"]):
                ...
                current_message_dict["AttributeList"]["AVAType"][OIDType]["length"] = (
                    length
                )
                current_message_dict["AttributeList"]["AVAType"][OIDType][
                    "AttributeValue"
                ...
                if type(OIDType) == str:
                    ...
                    current_message_dict_OID = current_message_dict["AttributeList"][
                        "AVAType"
    ...
    def readVariableLengthList(self, index, data_type, current_message_dict, data):
        ...
        current_message_dict[data_type]["length"] = self.get16(
            data[index + 2 : index + 4]
        )
        index += 4
        ...
        for i in range(current_message_dict[data_type]["count"]):
            ...
            current_message_dict_count = current_message_dict[data_type][
                data_value + "_" + str(i)
            ]

            index = self.recurseRead(
                [data_value], index, current_message_dict_count, data
            )
    ...
    def readVariableLabel(self, index, current_message_dict, data):
        ...
        current_message_dict["VariableLabel"]["length"] = self.get16(
            data[index : index + 2]
        )
    ...
    def readVariableData(self, index, current_message_dict, data):
        ...
        current_message_dict["VariableData"]["length"] = self.get16(
            data[index : index + 2]
        )
        ...
        for i in range(int(current_message_dict["VariableData"]["length"] / 2)):
            current_message_dict["VariableData"]["value"].append(
                self.get16(data[index : index + 2])
            )
            index += 2
    ...
    def recurseRead(self, message_list, index, current_message_dict, data):
        """Iterates recursively through data structure

        Parameters
        ----------
        message_list: list
             a list of the data types stored in the message

        index: int
            the current index being parsed
        ...
        for data_type in message_list:
            ...
            if type(data_type) != list:
                ...
                if (
                    "ASNLength" in data_type
                    or "LILength" in data_type
                    or "length" in data_type
                ):
                    index = self.readLengths(
                        index, current_message_dict, data, data_type
                    )
                ...
                # VariableLengthList needs separate parser
                    ...
                    index = self.readVariableLengthList(
                        index, data_type, current_message_dict, data
                    )
                ...
                # If there is an integer (ie got to basic data type)
                    ...
                    # Read out int16 (note: only 1 case)
                        ...
                        current_message_dict[data_type] = self.geti16(
                            data[index : index + 2]
                        )
                        index += 2
                        bit_range = b""
    ...
    def readData(self, data):
        """Main function to read in messages
        ...
        if message_type != "AssociationAbort":
            finalIndex = self.recurseRead(
                current_message_list, index, current_message_dict, data
            )
        else:
        ...
        if message_type == "ConnectIndicationEvent":
            IP = current_message_dict["ConnectIndInfo"]["AttributeList"]["AVAType"][
                "NOM_ATTR_NET_ADDR_INFO"
            ]["AttributeValue"]["IPAddressInfo"]["IPAddress"]
            IPAddress = (
            ...
            return (
                current_message_dict,
                current_message_dict["ConnectIndInfo"]["AttributeList"]["AVAType"][
                    "NOM_ATTR_PCOL_SUPPORT"
                ]["AttributeValue"]["ProtoSupport"]["ProtoSupportEntry_3"][
                    "ProtoSupportEntry"
                ]["port_number"],
                IPAddress,
            )
        # Output parameters necessary for MDSCreateEventResult
            ...
            params = {
                "session_id": current_message_dict["SPpdu"]["session_id"],
                ...
                "OIDType": [
                    current_message_dict["EventReportArgument"]["ManagedObjectID"][
                        "OIDType"
                    ],
                    current_message_dict["EventReportArgument"]["OIDType"],
                ],
                "MdsContext": current_message_dict["EventReportArgument"][
                    "ManagedObjectID"
                ]["GlbHandle"]["MdsContext"],
                "Handle": current_message_dict["EventReportArgument"][
                    "ManagedObjectID"
                ]["GlbHandle"]["Handle"],
                "RelativeTime": current_message_dict["EventReportArgument"][
                    "RelativeTime"
                ],
            }
    ...
    def readLengths(self, index, current_message_dict, data, data_type):
        ...
        if "ASNLength" in data_type:
            if self.get8(data[index : index + 1]) == 130:
                current_message_dict["ASNLength"] = self.get16(
                    data[index + 1 : index + 3]
                )
                index += 3

            elif self.get8(data[index : index + 1]) == 129:
                current_message_dict["ASNLength"] = self.get8(
            ...
            if self.get8(data[index : index + 1]) == 255:
                current_message_dict["LILength"] = self.get16(
                    data[index + 1 : index + 3]
                )
                index += 3
    ...
    def writeLengths(self, output_message, length, ASNLength, LILength, finalIndex):
        ...
        ASNLength: list
            list of ASNLength pairs

        LILength: list
            list of LILength pairs

        finalIndex: int
            final index of message
        ...
        for index, tuples in enumerate(all_lengths_sorted):
            ...
            if len(tuples) == 3:
                if length <= 127:
                    ...
                    for add_tuples in both_lengths_sorted[
                        index + 1 : len(both_lengths_sorted)
                    ]:
    ...
    def writeAttributeList(
        ...
        if message_list[1][0] == "Null":
            ...
            length[
                self.DataKeys["AttributeType"].get(
                    message_list[1][len(message_list[1]) - 1]
                )
                + "_"
                + str(index)
            ] = [index]
    ...
    def writeData(self, message_type, *parameter_input):
        """Main function to write messages

        Parameters
        ----------

        message_type: string
            type of message to be written

        *parameter_input: dict
            to specify parameters of certain messages


        Returns
        -------
        output_message: bytes
            message to send to monitor
        ...
        finalIndex = self.recurseWrite(
            message_list, output_message, length, ASNLength, LILength, index, parameters
        )

        # Compute lengths and edit output_message accordingly
        self.writeLengths(
            output_message, length, ASNLength, LILength, finalIndex
        )  # takes in index of length and index of what length was supposed to

        return bytes(output_message)

    # Writes TextIds
    def writeTextIdLabel(
        self,
        message_list,
        output_message,
        length,
        ...
        for data_type in message_list:
            ...
            if type(data_type) != list:
                ...
                # If data can still be broken down farther along the tree, then do so
                    ...
                    self.DataTypes.get(data_type, "none") != "none"
                    and type(self.DataTypes.get(data_type, "none")[0]) != int
                ):
                    index = self.recurseWrite(
                        self.DataTypes[data_type],
                        output_message,
                ...
                # Separate method to write AttributeIdLists
                    ...
                    index = self.writeAttributeIdList(
                        message_list,
                        output_message,
                        length,
                        ASNLength,
                ...
                # If data type not defined print it out
                    ...
                    print("Could not find data type for: " + data_type)
    ...
    def getMessageType(self, data):
        ...
        sessionHeader = data[0:1]

        if data.startswith(b"\x00\x00\x01\x00"):
            message_type = "ConnectIndicationEvent"

        elif sessionHeader == b"\x0d":
            # CN_SPDU_SI
            message_type = "AssociationRequest"

        elif sessionHeader == b"\x0e":
            # AC_SPDU_SI
            message_type = "AssociationResponse"

        elif sessionHeader == b"\x0c":
            # RF_SPDU_SI
            message_type = "AssociationRefuse"

        elif sessionHeader == b"\x09":
            # FN_SPDU_SI
            message_type = "ReleaseRequest"

        elif sessionHeader == b"\x0a":
            # DN_SPDU_SI
            message_type = "ReleaseResponse"

        elif sessionHeader == b"\x19":
            # AB_SPDU_SI
            message_type = "AssociationAbort"

        elif sessionHeader == b"\xe1":
...
if __name__ == "__main__":
    ...
    dat = IntellivueData()
    pp.pprint(dat.DataTypes)
    pp.pprint(dat.DataKeys)
    pp.pprint(dat.MessageLists)
    pp.pprint(dat.MessageParameters)
